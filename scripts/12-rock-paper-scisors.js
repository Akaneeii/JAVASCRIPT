let score=JSON.parse(localStorage.getItem('score')) || {
    ...
    function displayScoreAndMoves(result, player, computerMove){
        ...
        .innerHTML = `  You
        <img class="move-icon" src="../Lesson 10 - JS CSS HTML/icons/${player}-emoji.png" alt="">
        <img class="move-icon" src="../Lesson 10 - JS CSS HTML/icons/${computerMove}-emoji.png" alt="">
